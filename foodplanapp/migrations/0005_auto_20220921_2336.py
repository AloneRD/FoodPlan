# Generated by Django 3.2.15 on 2022-09-21 20:36
...
class Migration(migrations.Migration):
    ...
    def add_recipes(apps, schema_editor):
        ...
        for recipe in recipes:
            with open(os.path.join(base_directory, recipe), encoding='utf-8') as file:
                ...
                recipe_type = RecipeType.objects.get(name='Ужин')
    ...
    dependencies = [
        ('foodplanapp', '0004_auto_20220921_2331'),
    ]
